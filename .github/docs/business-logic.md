...
2. 自定义规则流程：打开 Control Panel -> 新建或切换 Profile -> 编辑 Single Key / Chord / Melody 规则 -> 保存后立即弹键验证。
3. Recorder 流程：打开 Control Panel 的 Recorder -> Rec 开始演奏 -> Stop 生成 Take -> 在 Library 选择 Take -> Play/Stop 回放。
