...
`python_backend/duet/requirements.txt` 是服务端依赖真源；如需启用 Magenta/TF，引入 `python_backend/duet/requirements-magenta.txt`（或 locked 版本）。
...
| Python 模型/素材 | 不应提交到仓库 | `python_backend/duet/models/`。 |
