    ...
    func noteEventCoverages() -> [PianoHighlightParsedElementCoverage] {
        [
            coverage(
                ...
                .derivedConsumed,
                "Used with staff/voice/tick to correlate source notes and spans."
            ),
            coverage(
                "MusicXMLNoteEvent.measureNumber",
                .metadataOnly,
                "Measure identity is preserved for diagnostics; tick drives highlight ordering."
            ),
            coverage("MusicXMLNoteEvent.tick", .consumed, "Guide trigger/release ordering is tick based."),
            coverage(
                "MusicXMLNoteEvent.durationTicks",
                .derivedConsumed,
                "Duration contributes to MusicXMLNoteSpan offTick."
            ),
            ...
            coverage(
                ...
                .derivedConsumed,
                "Same-tick notes are grouped into one trigger guide."
            ),
            coverage(
                "MusicXMLNoteEvent.isGrace",
                .derivedConsumed,
                "Grace notes are included or deferred according to expressivity options."
            ),
            coverage(
                "MusicXMLNoteEvent.graceSlash",
                .derivedConsumed,
                "Grace scheduling is delegated to existing builders."
            ),
            coverage(
            ...
            coverage(
                ...
                .derivedConsumed,
                "Tie starts are preserved through PracticeStepBuilder and NoteSpanBuilder."
            ),
            ...
            coverage(
                ...
                .derivedConsumed,
                "Resolved into PracticeStepNote/PianoHighlightNote velocity."
            ),
            coverage(
                "MusicXMLNoteEvent.articulations",
                .derivedConsumed,
                "Articulation shortening is reflected through MusicXMLNoteSpanBuilder."
            ),
            coverage(
                "MusicXMLNoteEvent.arpeggiate",
                .derivedConsumed,
                "Arpeggiate offsets are reflected through PracticeStepNote.onTickOffset."
            ),
    ...
    func scoreCoverages() -> [PianoHighlightParsedElementCoverage] {
        [
            ...
            coverage(
                ...
                .metadataOnly,
                "Tempo affects playback scheduling; guide tick ordering remains tempo independent."
            ),
            coverage(
                "MusicXMLScore.soundDirectives",
                .preprocessed,
                "May be materialized by structure expansion and words semantics."
            ),
            coverage(
                "MusicXMLScore.pedalEvents",
                .explicitlyDeferred,
                "Pedal sustain is used by audio; visual sustain extension is deferred."
            ),
            coverage(
                "MusicXMLScore.dynamicEvents",
                .derivedConsumed,
                "Velocity resolver feeds PracticeStepNote/PianoHighlightNote velocity."
            ),
            coverage(
                "MusicXMLScore.wedgeEvents",
                .derivedConsumed,
                "Velocity resolver can consume wedge ramps when enabled."
            ),
            coverage("MusicXMLScore.fermataEvents", .derivedConsumed, "Fermata can affect note spans when enabled."),
            coverage(
                "MusicXMLScore.slurEvents",
                .metadataOnly,
                "Slur timeline is preserved for UI/query but does not alter key highlight in this feature."
            ),
            coverage(
                "MusicXMLScore.timeSignatureEvents",
                .metadataOnly,
                "Preserved by timelines; not a key highlight input."
            ),
            coverage(
            ...
            coverage(
                ...
                .preprocessed,
                "Can derive tempo/pedal semantics before guide construction."
            ),
